'''cfg file for coco2017 dataset, resnet34 backbone'''
...
# record
TRAIN_BACKUPDIR = 'faster_res34_trainbackup_coco'
TRAIN_LOGFILE = 'faster_res34_trainbackup_coco/train.log'
TEST_BACKUPDIR = 'faster_res34_testbackup_coco'
TEST_LOGFILE = 'faster_res34_testbackup_coco/test.log'
TEST_BBOXES_SAVE_PATH = 'faster_res34_testbackup_coco/faster_res34_detection_results_coco.json'
SAVE_INTERVAL = 1