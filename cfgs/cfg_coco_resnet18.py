'''cfg file for coco2017 dataset, resnet18 backbone'''
...
# record
TRAIN_BACKUPDIR = 'faster_res18_trainbackup_coco'
TRAIN_LOGFILE = 'faster_res18_trainbackup_coco/train.log'
TEST_BACKUPDIR = 'faster_res18_testbackup_coco'
TEST_LOGFILE = 'faster_res18_testbackup_coco/test.log'
TEST_BBOXES_SAVE_PATH = 'faster_res18_testbackup_coco/faster_res18_detection_results_coco.json'
SAVE_INTERVAL = 1