...
'''smooth l1 loss'''
def smoothL1Loss(bbox_pred, bbox_targets, bbox_inside_weights, bbox_outside_weights, sigma=1.0, dim=[1]):
	sigma_2 = sigma ** 2
...
def betaSmoothL1Loss(bbox_pred, bbox_targets, beta=1, size_average=True):
